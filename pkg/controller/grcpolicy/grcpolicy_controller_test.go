...
func TestReconcile(t *testing.T) {
	...
	instance := &mcmv1alpha1.IamPolicy{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the IamPolicy object and expect the Reconcile and policy to be created
...
func createPolicy(policyName, PolicyNamespace string, remediation mcmv1alpha1.RemediationAction) (plc *mcmv1alpha1.IamPolicy) {
	return &mcmv1alpha1.IamPolicy{
