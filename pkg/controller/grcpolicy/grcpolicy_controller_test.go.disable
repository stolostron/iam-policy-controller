...
func TestReconcile(t *testing.T) {
	...
	instance := &policiesv1.IamPolicy{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
...
func createPolicy(policyName, PolicyNamespace string, remediation policiesv1.RemediationAction) (plc *policiesv1.IamPolicy) {
	return &policiesv1.IamPolicy{
