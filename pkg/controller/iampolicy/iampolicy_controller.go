...
import (
	...
	policyv1 "github.com/open-cluster-management/iam-policy-controller/pkg/apis/policy/v1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &policyv1.IamPolicy{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create that are owned by the primary resource
	// Watch for changes to secondary resource Pods and requeue the owner IamPolicy
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &policyv1.IamPolicy{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileIamPolicy) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set IamPolicy instance as the owner and controller
...
func newPodForCR(cr *policyv1.IamPolicy) *corev1.Pod {
